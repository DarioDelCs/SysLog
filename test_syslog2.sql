...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 07-04-2019 a las 21:56:49
...
-- Procedimientos
--
CREATE DEFINER=`root`@`localhost` PROCEDURE `deleteUsers` (IN `id` CHAR(20))  BEGIN
  DELETE from users
  WHERE USER_ID = id;
END$$
...
(1, 'log', 'name', 'pass', 'email', 'profile'),
(2, 'log2', 'Name', '123', 'Email', 'Profile');
